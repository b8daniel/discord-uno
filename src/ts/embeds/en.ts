...
export const ERR_BASE = new MessageEmbed().setColor("#ED4245").setTitle("An error accoured!");

export const BASE_EMB = new MessageEmbed().setColor(primaryColor);

export const ADD_EMBED = new MessageEmbed()
  .setTitle(
    ":partying_face: Thank you for adding me to your server! Get an Overview of the next steps with /tutorial"
  )
  .setTimestamp()
  .setColor("#F45886");
...
export const TUTORIAL_EMBED_ADMIN = new MessageEmbed(BASE_EMB)
  ...
  .addField(
    ...
    "I need to know, where all the gaming action should take place. The only way i know is if you tell it me trough this command."
  );
...
export const JOIN_GAME_EMBED = new MessageEmbed(BASE_EMB).setDescription(
  "Join the thread to join the game!"
);

export const INGAME_OVERVIEW = new MessageEmbed().setImage("attachment://overview.png");
