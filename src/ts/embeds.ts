...
export const TUTORIAL_EMBED_ADMIN = new MessageEmbed()
...
export const TUTORIAL_EMBED_USER = new MessageEmbed()
  .setColor(primaryColor)
  .setTitle("How to...")
...
export const GAME_CONTROLS = new MessageEmbed()
  .setColor(primaryColor)
  .setTitle("⚔️ Use the buttons to start a game! 🎮");

export const GAME_CONTROL_COMPONENTS: MessageOptions["components"] = [
  new MessageActionRow().addComponents(
    new MessageButton().setStyle("SUCCESS").setEmoji("🎮").setLabel("new game").setCustomId("uno-creategame")
  )
];

export const JOIN_GAME_EMBED = new MessageEmbed()
  .setColor(primaryColor)
...
export const INGAME_COMPONENTS: MessageOptions["components"] = [
  new MessageActionRow().addComponents(
